...
t1, t2, t3 = hybrid_frame.symbols()

m1 = hybrid_frame.mass({t1: 0.1, t2: 0.4, t3: 0.2, t1 | t2: 0.3})
m2 = hybrid_frame.mass({t1: 0.5, t2: 0.1, t3: 0.3, t1 | t2: 0.1})
print_mass("Hybrid model / DSmH with t3 = empty", m1.dsmh(m2))
